...
public class TrinitySchemaHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    private readonly IAuthenticationService _authenticationService;

    public TrinitySchemaHandler(
    ...
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        return AuthenticateResult.Success(new AuthenticationTicket(principal, AuthSchemas.TrinitySchema));
    }
}
