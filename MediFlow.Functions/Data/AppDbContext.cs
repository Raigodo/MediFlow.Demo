...
using MediFlow.Functions.Entities.Clients.Configuration;
using MediFlow.Functions.Entities.Employees;
using MediFlow.Functions.Entities.Employees.Configuration;
using MediFlow.Functions.Entities.Notes;
using MediFlow.Functions.Entities.Notes.Configuration;
using MediFlow.Functions.Entities.Structures;
using MediFlow.Functions.Entities.Structures.Configuration;
using MediFlow.Functions.Entities.Users;
using MediFlow.Functions.Entities.Users.Configuration;
using MediFlow.Functions.Entities.Users.Values;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

namespace MediFlow.Functions.Data;
